...
async function main() {
  ...
  const txt = await bondNFT.initialize("Howie B","howie_b","UCOmHUn--16B90oW2L6FRR3Ab","channel","audiusArtistId",BigNumber.from("1000"),BigNumber.from("3"),BigNumber.from("10"),BigNumber.from("2000"));
